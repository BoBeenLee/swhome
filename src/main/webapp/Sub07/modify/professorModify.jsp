...
<table align="center">
	<tr>
		...
		<td><input type="text" name="id" id="id" disabled="disabled" value=""/></td>
	</tr>
	<tr>
		<th scope="row"><label for="name">이름</label></th>
		<td><input type="text" name="name" id="name" maxlength="20" title="이름을 입력하세요" />
			<br/>
			이름은 2~20자 이내여야 합니다 </td>
	</tr>
	<tr>
		<th scope="row"><label for="email">이메일 주소</label></th>
		<td><input type="text" name="email" id="email" title="이메일 주소를 입력하세요" />
			<br/>
			메일주소는 메일인증 후 비밀번호 변경이나 찾기등에 사용됩니다. </td>
	</tr>
	<tr>
		<th scope="row"><label for="phone">전화번호</label></th>
		<td><input type="text" name="phone" id="phone" title="전화번호를 입력하세요" /></td>
	</tr>
	<tr>
		...
		<td><input type="text" name="answer" id="answer" title="학년를 입력하세요" /></td>
	</tr>
	<tr>
		<th scope="row"><label for="location">교수실 위치</label></th>
		<td><input type="text" name="location" id="location" title="교수실 위치를 입력하세요" /></td>
	</tr>
	<tr>
		<th scope="row"><label for="extenstion">외선 번호</label></th>
		<td><input type="text" name="extenstion" id="extenstion" title="외선 번호를 입력하세요" /></td>
	</tr>
</table>
	<input type="hidden" name="idx" value="professorModify"/>
