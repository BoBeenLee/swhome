		...
		return this.each(function() {
			...
			for(var key in carousel_data) {
				...
				if(carousel_data.hasOwnProperty(key)) {
					...
					ac_numbered_buttons += "<div class='slide_number_" + i + " numbered_button slide_button " + get_trigger_type("numbered_buttons") + " imgbutton' data-options='{\"button_type\":\"numbered_button\",\"button_action\":\"direct\",\"go_to\":" + i + ", \"trigger_type\":\"" + ac_trigger_type + "\",\"disabled\": false}' style='width: 15px; height: 15px;'>" + "</div>";
			...
			/*pause_button.click(function() { 이부분에서 오류나서 주석 처리를 임시로 하였습니다.
				var $this = $(this);
