...
<script type="text/javascript">
	jQuery(document).ready(
			function($) {
				...
				$("#freeSearch").click(
						function(e) {
							window.document.location.href = "#board?req=1&"
									+ "searchType="
...
<body>
	<div>
		<img src="Sub04/img/content-1/subtop4-1.PNG" width="754px" />
	</div>
	<div class="rightContent">
		<div id="free_container" class="bbs">
			<table>
				<thead>
					<tr>
						<th width="60px">번호</th>
					...
					<c:forEach items="${ articleList }" var="article" varStatus="num">
						<tr>
							...
							<td style="text-align: left !important;"><a
								href="#board?req=1&articleId=${ article.norArticleId }&type=read">${
		...
		<div align="center">
			...
			<c:if test="${ userInfo != null }"><input type="button"
				onclick="javascript_:window.document.location.href='#board?req=1&type=write'"
				value="글쓰기" /></c:if>
		</div>
		<!--! end of #content -->
	</div>
