...
<script type="text/javascript">
	jQuery(document).ready(
			function($) {
				...
				$("#honorSearch").click(
						function(e) {
							window.document.location.href = "#board?req=3&"
									+ "searchType="
...
<body>
	<div>
		<img src="Sub04/img/content-3/subtop4-3.PNG" width="754px" />
	</div>
	<div class="rightContent">
		<div id="honor_container" class="bbs">
			<table>
				<thead>
					<tr>
						<th width="60px">번호</th>
					...
					<c:forEach items="${ articleList }" var="article" varStatus="num">
						<tr>
							...
							<td style="text-align: left !important;"><a
								href="#board?req=3&articleId=${ article.norArticleId }&type=read">${
		...
		<div align="center">
			...
			<c:if test="${ userInfo != null && ( userInfo.codeName == '관리자' || userInfo.codeName == '교수' ) }"><input type="button"
				onclick="javascript_:window.document.location.href='#board?req=3&type=write'"
				value="글쓰기" /></c:if>
		</div>
		<!--! end of #content -->
	</div>
