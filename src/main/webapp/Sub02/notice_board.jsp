...
<script type="text/javascript">
	jQuery(document).ready(
			function($) {
				...
				$("#noticeSearch").click(
						function(e) {
							window.document.location.href = "#admin?req=1&"
									+ "searchType="
...
<body>
	<div>
		<img src="Sub02/img/content-1/subtop2-1.PNG" width="754px" />
	</div>
	<div id="notice_content" class="rightContent">
		<div id="notice_container" class="bbs">
			<table>
				<thead>
					<tr>
						<th width="60px">번호</th>
					...
					<c:forEach items="${ articleList }" var="article" varStatus="num">
						<tr>
							...
							<td style="text-align: left !important;"><a
								href="#admin?req=1&articleId=${ article.norArticleId }&type=read">${
		...
		<div align="center">
			...
			<c:if
				test="${ userInfo != null && ( userInfo.codeName == '관리자' || userInfo.codeName == '교수' ) }">
				<input type="button"
					onclick="javascript_:window.document.location.href='#admin?req=1&type=write'"
					value="글쓰기" />
			</c:if>
		</div>
		<!--! end of #content -->
