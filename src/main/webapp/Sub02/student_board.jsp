...
<script type="text/javascript">
	jQuery(document).ready(
			function($) {
				...
				$("#studentSearch").click(
						function(e) {
							window.document.location.href = "#admin?req=2&"
									+ "searchType="
...
<body>
	<div>
		<img src="Sub02/img/content-2/subtop2-2.PNG" width="754px" />
	</div>
	<div id="student_content" class="rightContent">
		<div id="student_container" class="bbs">
			<table>
				<thead>
					<tr>
						<th width="60px">번호</th>
					...
					<c:forEach items="${ articleList }" var="article" varStatus="num">
						<tr>
							...
							<td style="text-align: left !important;"><a
								href="#admin?req=2&articleId=${ article.norArticleId }&type=read">${
		...
		<div align="center">
			...
			<c:if test="${ userInfo != null && ( userInfo.codeName == '관리자' || userInfo.codeName == '교수' || userInfo.codeName == '학생회' ) }"><input type="button"
				onclick="javascript_:window.document.location.href='#admin?req=2&type=write'"
				value="글쓰기" /></c:if>
		</div>
		<!--! end of #content -->
	</div>
