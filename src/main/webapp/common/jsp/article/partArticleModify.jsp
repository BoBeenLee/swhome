...
<script type="text/javascript">
	...
	function deleteFile(fileId) {
		var dataString = {"idx" : "file", "fileId" : fileId, "fileUrl" : fileUrl};
		
		jQuery.ajax({
			type : "POST",
			url : "/swHome/DeleteServlet",
			data :  dataString,
...
<body>
	...
	<div class="rightContent">
		<div class="article">
		<form id="partForm" action="UpdateServlet" method="post">
			<table>
				<tr>
					<th colspan="1">제목</th>
			...
			<div id="articleMenu">
				...
				<div id="fileContainer">
					...
					<br />
					<span id="fileCount">0</span> <a id="pickfiles"
					...
					<ul>
						<c:forEach var="filetmp" items="${ fileList }">
							<li style="list-style: none;"><span>${
								 ...
								 onclick="deleteFile('${ filetmp.fileId }', '${ filetmp.fileUrl }')">X</a></li>
						</c:forEach>
					</ul>
				</div>
				...
				<input type="hidden" name="articleWriterId" value="${ partArticle.partArticleWriterId }">
			</div>
		</form>
		</div>
	</div>
