...
<body>
	...
	<div class="rightContent">
		<div class="article">
		<form id="norForm" action="UpdateServlet" method="post">
			<table>
				<tr>
					<th colspan="1">제목</th>
			...
			<div id="articleMenu">
					...
					<ul>
						<c:forEach var="filetmp" items="${ fileList }">
							<li style="list-style: none;">
								...
								<a href="javascript:void(0)" onclick="deleteFile('${ filetmp.fileId }', '${ filetmp.fileUrl }')">X</a>
							</li>
						</c:forEach>
					</ul>
				</div>
				...
				<input type="hidden" name="articleWriterId" value="${ norArticle.norArticleWriterId }">
			</div>
		</form>
		</div>
	</div>
